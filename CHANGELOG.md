...
- Live GitHub Pages browser demo using the real Web Component and module Worker path, including seed controls and deterministic replay verification.
...
- Public API, resource benchmark, and known-limitations documentation for v0.1.
...
- Web embedding documentation and browser demo pages.
...
- MIT License.
- v0.1 world spec, run-manifest contract, JSON Schema artifact, validation test vectors, and three sample worlds.

### Changed

- Reconciled the security model, run-manifest contract, README, package surface, and v0.1 release checklist with the executable v0.1 behavior.
...
- Documented the requirement for explicit runtime resource limits and fail-closed validation.
